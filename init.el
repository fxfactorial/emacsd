...
(custom-set-variables
 ...
 '(connection-local-profile-alist
   '((autogenerated-connection-local-profile/\(:application\ vc-git\ :protocol\ \"ssh\"\ :machine\ \"mev-prod-home\"\)
      (vc-git--program-version . "2.34.1"))
     (autogenerated-connection-local-profile/\(:application\ vc-git\ :protocol\ \"ssh\"\ :machine\ \"thelio-archive\"\)
      (vc-git--program-version . "2.34.1"))
