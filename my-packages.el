...
(setq package-selected-packages '(
				  ace-window ag applescript-mode avy bui cargo cargo-mode cfrs clang-format
				  ...
				  magit-section markdown-mode nerd-icons pfuture popup posframe prettier-js protobuf-mode
				  ...
				  transient treemacs typescript-mode undo-tree vertico web-completion-data web-mode which-key
				  winum with-editor yaml-mode yasnippet yasnippet-snippets))
